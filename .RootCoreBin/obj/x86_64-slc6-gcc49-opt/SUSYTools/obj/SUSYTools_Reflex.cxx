...
#define R__DICTIONARY_FILENAME dIxdIcalodIjgoncalvesdIJetCleaningHIdIRootCoreBindIobjdIx86_64mIslc6mIgcc49mIoptdISUSYToolsdIobjdISUSYTools_Reflex
...
#include "/cvmfs/atlas.cern.ch/repo/sw/ASG/AnalysisBase/2.4.8/SUSYTools/SUSYTools/SUSYToolsDict.h"
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::ST::ISUSYObjDef_xAODTool*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("ST::ISUSYObjDef_xAODTool", "SUSYTools/ISUSYObjDef_xAODTool.h", 99,
