...
public:
  ...
  TauEfficiencyTriggerTool(std::string sName, std::string sInputFilePath = "", std::string sVarName = "", bool bSkipTruthMatchCheck = false, std::string sWP = "", e_DataPeriodBinning m_ePeriodBinning = PeriodBinningUnknown);
...
protected:
  ...
  e_DataPeriodBinning m_ePeriodBinning;
