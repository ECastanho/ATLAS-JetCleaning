...
namespace CP {
   ...
   public:
      ...
      using asg::AsgTool::setProperty;
#ifndef XAOD_STANDALONE
      virtual StatusCode setProperty( const Property& p  ) { return asg::AsgTool::setProperty(p); }
      virtual StatusCode setProperty( const std::string& s ) { return asg::AsgTool::setProperty(s); }
#endif
      virtual StatusCode setProperty( const std::string& n, int val ) { return asg::AsgTool::setProperty(n,val); }
      virtual StatusCode setProperty( const std::string& n, double val ) { return asg::AsgTool::setProperty(n,val); }
      virtual StatusCode setProperty( const std::string& n, const std::string& v ) { return asg::AsgTool::setProperty(n,v); }
      virtual StatusCode setProperty( const std::string& n, const char* v ) { return asg::AsgTool::setProperty(n,v); }
      virtual StatusCode setProperty( const std::string& propName, const std::vector<std::string>& val  ) { return asg::AsgTool::setProperty(propName,val); }

#ifdef XAOD_STANDALONE
      //add way to specify GRLTool in standalone code
      virtual StatusCode setProperty( const std::string& propName, IGoodRunsListSelectionTool* grl ) { return asg::AsgTool::setProperty(propName,grl); }
#endif
      ...
      virtual float getCorrectedMu( const xAOD::EventInfo& eventInfo, bool includeDataScaleFactor );
