...
namespace ST {
  ...
  class ISUSYObjDef_xAODTool : public virtual asg::IAsgTool {
    ...
    virtual double GetMuonTriggerEfficiency(const xAOD::Muon& mu, const std::string& trigExpr = "HLT_mu20_iloose_L1MU15_OR_HLT_mu50") = 0;
    ...
    virtual float GetSignalTauSFsys(const xAOD::TauJet& tau, const CP::SystematicSet& systConfig) = 0;
