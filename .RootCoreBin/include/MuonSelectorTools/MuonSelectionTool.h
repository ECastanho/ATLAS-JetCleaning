...
namespace CP {
   ...
   public:
     ...
     bool passTight(const float pt, const float eta, const float rho, const float oneOverPSig) const;
      /// @}
   ...
   private:
     ...
     bool checkTightCut(const float pt, const float lowBoundPt,const float higherBoundPt,
                        const float rho, const float rhoCut,
                        const float oneOverPSig, const float oneOverPSigCut) const;
