...
{
  enum e { MMC2011=0, MMC2012, MMC2015, MMC2015HIGHMASS, UPGRADE, LFVMMC2012, MAXMMCCALIBRATIONSET };
  const std::string name[MAXMMCCALIBRATIONSET]={ "MMC2011", "MMC2012", "MMC2015", "MMC2015HIGHMASS", "UPGRADE", "LFVMMC2012"};
}
...
private:
  ...
  void PrintResults(const OutputInfoStuff & fStuff);
...
public:
  ...
  TH1F * GetMassHistogram(); // return mass histogram
  TH1F * GetMassHistogramNoWeight(); // return mass histogram without weights
