...
namespace InDet {
  ...
  private:
    ...
    // functions for describing resolution in data and MC from material differences
    TF2* m_smearD0FunctionMC = nullptr;
    TF2* m_smearD0FunctionData = nullptr;
    TF2* m_smearZ0FunctionMC = nullptr;
    TF2* m_smearZ0FunctionData = nullptr;
