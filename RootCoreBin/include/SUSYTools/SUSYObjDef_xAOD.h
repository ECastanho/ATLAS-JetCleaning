...
class SUSYObjDef_xAOD : public virtual ISUSYObjDef_xAODTool,
  ...
  public:
    ...
    // Hack to make this configurable from python
    ...
    double GetMuonTriggerEfficiency(const xAOD::Muon& mu, const std::string& trigExpr = "HLT_mu20_iloose_L1MU15_OR_HLT_mu50");

    float GetSignalTauSF(const xAOD::TauJet& tau);

    float GetSignalTauSFsys(const xAOD::TauJet& tau, const CP::SystematicSet& systConfig);
  ...
  protected:
    ...
    std::string m_EG_corrFile_id_fallback;
    std::string m_EG_corrFile_trig_singleLep_fallback;
    std::string m_EG_corrFile_trig_diLep_fallback;
    std::string m_EG_corrFile_trig_mixLep_fallback;
    std::string m_EG_corrFile_iso_fallback;

    std::string m_EG_corrFile_trigEff_singleLep;
    std::string m_EG_corrFile_trigEff_diLep;
    std::string m_EG_corrFile_trigEff_mixLep;
    std::string m_EG_corrFile_trigEff_singleLep_fallback;
    std::string m_EG_corrFile_trigEff_diLep_fallback;
    std::string m_EG_corrFile_trigEff_mixLep_fallback;
    ...
    ToolHandle<IAsgElectronEfficiencyCorrectionTool> m_elecEfficiencySFTool_trigEff_singleLep_fallback;
    ToolHandle<IAsgElectronEfficiencyCorrectionTool> m_elecEfficiencySFTool_trigEff_diLep_fallback;
    ToolHandle<IAsgElectronEfficiencyCorrectionTool> m_elecEfficiencySFTool_trigEff_mixLep_fallback;
    //
    ...
    //
    ToolHandle<IAsgElectronLikelihoodTool> m_elecSelLikelihood_fallback;
    ToolHandle<IAsgElectronEfficiencyCorrectionTool> m_elecEfficiencySFTool_id_fallback;
    ToolHandle<IAsgElectronEfficiencyCorrectionTool> m_elecEfficiencySFTool_trig_singleLep_fallback;
    ToolHandle<IAsgElectronEfficiencyCorrectionTool> m_elecEfficiencySFTool_trig_diLep_fallback;
    ToolHandle<IAsgElectronEfficiencyCorrectionTool> m_elecEfficiencySFTool_trig_mixLep_fallback;
    ToolHandle<IAsgElectronEfficiencyCorrectionTool> m_elecEfficiencySFTool_iso_fallback;
    //
