...
public:
  ...
  virtual TLorentzVector getTruthTauP4Invis(const xAOD::TauJet& xTau) const = 0;
  ...
  virtual TauAnalysisTools::TruthMatchedParticleType getTruthParticleType(const xAOD::TauJet& xTau) const = 0;
